...
with tf.Session(config=tf.ConfigProto(gpu_options=tf.GPUOptions(per_process_gpu_memory_fraction=0.50))) as sess:
    ...
    saver = tf.train.import_meta_graph("/home/danhnguyen/Documents/git/Tensorflow-TensorRT/model/tensorflow/small/model_small.meta")
    # then, restore the weights to the meta graph
    #saver.restore(sess, "./model/tensorflow/big/model1")
    saver.restore(sess, "/home/danhnguyen/Documents/git/Tensorflow-TensorRT/model/tensorflow/small/model_small")
    ...
    with gfile.FastGFile("/home/danhnguyen/Documents/git/Tensorflow-TensorRT/model/frozen_model.pb", 'wb') as f:
